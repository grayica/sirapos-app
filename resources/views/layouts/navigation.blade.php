<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur-lg border-b border-gray-200 shadow-sm sticky top-0 z-50">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-11 h-11 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600
    ...
    <div x-show="open" x-transition class="sm:hidden relative z-[60] bg-white">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('posyandu.index')" :active="request()->routeIs('posyandu.*')">
                {{ __('Posyandu') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('peserta.index')" :active="request()->routeIs('peserta.*')">
                {{ __('Peserta') }}
            </x-responsive-nav-link>
