...
<table class="summary">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="number" width="12%">
                {{ $jadwals->where('status','Scheduled')->count() }}
            </td>
        ...
        <tr>
            ...
            <td class="number">
                {{ $jadwals->where('status','Completed')->count() }}
            </td>
            ...
            <td class="number">
                {{ $jadwals->where('status','Draft')->count() }}
            </td>
        ...
        <tr>
            ...
            <td class="number">
                {{ $jadwals->where('status','Cancelled')->count() }}
            </td>
            ...
            <td>
                ...
                {{ optional($jadwals->first())->tanggal
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                {{ optional($jadwals->last())->tanggal
                    ? \Carbon\Carbon::parse($jadwals->last()->tanggal)->translatedFormat('d F Y')
                    : '-' }}
...
<div style="margin-bottom:18px">
    ...
    <div style="margin-top:8px">
        ...
        Laporan ini merupakan rekapitulasi seluruh jadwal kegiatan Posyandu
